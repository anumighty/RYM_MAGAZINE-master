...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAA8MiHy1k:APA91bFh2VfQzCGOuj5mtVqrsn0YJ6aBi92ThcC2bLf4uUzs9mkb6DTPX1cYhzm63Z0xBCE1upJHAS_9pvZlQctWznZ2ptbFG7EkeT1crH1erWRsBC9LeneiQQsprRlLZIuL1H-QHRsTGOrqTev1-jCnwLXEQC1xrQ";
    ...
    private static final String UserProfPics = "picsUrl";
    ...
    public FcmNotificationBuilder receiver(String receiver) {
        mReceiver = receiver;
        return this;
    }

    public FcmNotificationBuilder topic(String topic) {
        mTopic = topic;
        return this;
    }

    public FcmNotificationBuilder userProfPics(String picsUrl) {
        mProfPics = picsUrl;
        return this;
    }
   ...
   /* public FcmNotificationBuilder uid(String uid) {
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        jsonObjectData.put(Receiver, mReceiver);
        jsonObjectData.put(Topic, mTopic);
        jsonObjectData.put(UserProfPics, mProfPics);
