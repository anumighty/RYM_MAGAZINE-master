...
package com.rym.magazine.fragment;
...
import com.rym.magazine.view.EntryView;
        ...
        if (mEntriesIds != null) {
            ...
            switch (item.getItemId()) {
                    ...
                    if (cursor != null) {
                        ...
                        if (link != null) {
                            ...
                            startActivity(Intent.createChooser(
                                    new Intent(Intent.ACTION_SEND).putExtra(Intent.EXTRA_SUBJECT, title).putExtra(Intent.EXTRA_TEXT, "RYM MAGAZINE FEEDS\n\nI am sharing this news to you from RYM magazine\n"+link+"\n\nDownload RYM Magazine app from www.therymmagazine.com to get updated with news too.")
                ...
                case R.id.menu_full_screen: {
                    ...
                    Toast.makeText(activity, "Swipe DOWN from TOP to exit fullscreen", Toast.LENGTH_LONG).show();
