...
package com.rym.magazine.adapter;
...
import com.rym.magazine.utils.StringUtils;
...
public class DrawerAdapter extends BaseAdapter {
    ...
    private static final int GROUP_TEXT_COLOR = Color.parseColor("#f2900f");
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Save the Unread feeds count so as to shw it on the MainActivity Nav Drawer
        ...
        if (position == 0 || position == 1 || position == 2) {
            switch (position) {
                case 0:
                    ...
                    editor.putString("UnreadFeedsCount", String.valueOf(mAllUnreadNumber));
                    editor.apply();
                    break;
                case 1:
