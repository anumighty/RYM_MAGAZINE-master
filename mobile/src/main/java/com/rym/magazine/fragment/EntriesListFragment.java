...
import com.rym.magazine.activity.GeneralPrefsActivity;
import com.rym.magazine.adapter.EntriesCursorAdapter;
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mEntriesCursorAdapter != null) {
                    ...
                    Toast.makeText(activity, "All feeds marked as read", Toast.LENGTH_SHORT).show();
                }
            }
        });
