...
package com.rym.magazine.mag.curl;
...
public class CurlActivity extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rymites_gallery);
		...
		mCurlView.setBackgroundColor(0xAF202830);
	...
	private class PageProvider implements CurlView.PageProvider {
        ...
        // Bitmap resources.
        private int[] mBitmapIds = {R.drawable.galleryhome, R.drawable.gallery2,
                R.drawable.gallery3, R.drawable.gallery4, R.drawable.galleryall};
